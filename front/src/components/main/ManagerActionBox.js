    ...
    return (<div id="manager_action_box">
        <Container maxWidth="lg" sx={{marginTop: 3}}>
            <Grid container spacing={0}>
                <Grid item xs={6}>
                    <ListOfManaged login={props.login} role={props.role} setAction={props.setAction}/>
                </Grid>
                <Grid item xs={6}>
                    <SetNextTraining login={props.login} role={props.role} setAction={props.setAction}/>
                </Grid>
                <Grid item xs={6}>
                    <Buildings login={props.login} role={props.role} setAction={props.setAction}/>
                </Grid>
                <Grid item xs={6}>
                    <ListOfPeopleWithoutAManager login={props.login} role={props.role} setAction={props.setAction}/>
                </Grid>
            </Grid>
            <Grid container spacing={0}>
                <Grid item xs={6}>
                ...
                <Grid item xs={6}>
                    <ManageNewPerson login={props.login} role={props.role} setAction={props.setAction}/>
                </Grid>
                <Grid item xs={6}>
                    <ManageStaff login={props.login} role={props.role} setAction={props.setAction}/>
                </Grid>
                <Grid item xs={6}>
                    <SetEvent login={props.login} role={props.role} setAction={props.setAction}/>
                </Grid>
            </Grid>
        </Container>
    </div>)
